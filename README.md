...
- `POST /api/asset-cards/refresh-scan/bulk` - поставить все сохранённые или только устаревшие карточки на последовательное обновление через повторное сканирование; прогресс публикуется в `/api/operations`.
